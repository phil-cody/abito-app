					...
					<div className="container">
						<div className="search-box">
							...
							<button className="btn btn-primary search-btn">
								<img className="search-btn-icon" src="/image/search.svg" alt="search" />
								...
								<div className="content-side__box">
									<div className="content-side__list">
										<div className="content-side__list-item">
											<img src="/image/side-info-1.svg" alt="side-info" className="content-side__list-item--img" />
										...
										<div className="content-side__list-item">
											<img src="/image/side-info-2.svg" alt="side-info" className="content-side__list-item--img" />
										...
										<div className="content-side__list-item">
											<img src="/image/side-info-3.svg" alt="side-info" className="content-side__list-item--img" />
